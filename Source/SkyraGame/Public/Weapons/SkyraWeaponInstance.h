...
#include "SkyraWeaponInstance.generated.h"
...
public:
	USkyraWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FSkyraAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FSkyraAnimLayerSelectionSet UneuippedAnimSet;

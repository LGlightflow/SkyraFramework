...
#include "SkyraGameplayAbility_Death.generated.h"
 ...
 */
UCLASS(Abstract)
class USkyraGameplayAbility_Death : public USkyraGameplayAbility
{
	GENERATED_BODY()

public:

	USkyraGameplayAbility_Death(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Skyra|Death")

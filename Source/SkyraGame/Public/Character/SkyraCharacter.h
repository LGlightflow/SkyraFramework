...
#include "SkyraCharacter.generated.h"
...
class USkyraPawnExtensionComponent;
class UObject;
struct FFrame;
struct FGameplayTag;
...
/**
 * FSkyraReplicatedAcceleration: Compressed representation of acceleration
 */
USTRUCT()
struct FSkyraReplicatedAcceleration
{
	GENERATED_BODY()
...
class SKYRAGAME_API ASkyraCharacter : public AModularCharacter, public IAbilitySystemInterface, public IGameplayCueInterface, public IGameplayTagAssetInterface, public ISkyraTeamAgentInterface
{
	GENERATED_BODY()

public:

	ASkyraCharacter(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Skyra|Character", Meta = (AllowPrivateAccess = "true"))
	TObjectPtr<USkyraHealthComponent> HealthComponent;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Skyra|Character", Meta = (AllowPrivateAccess = "true"))
	TObjectPtr<USkyraCameraComponent> CameraComponent;

	UPROPERTY(Transient, ReplicatedUsing = OnRep_ReplicatedAcceleration)
	FSkyraReplicatedAcceleration ReplicatedAcceleration;

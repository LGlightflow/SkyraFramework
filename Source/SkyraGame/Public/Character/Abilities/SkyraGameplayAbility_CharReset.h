...
#include "SkyraGameplayAbility_CharReset.generated.h"
...
/**
 * USkyraGameplayAbility_CharReset
 *
 ...
 */
UCLASS()
class SKYRAGAME_API USkyraGameplayAbility_CharReset : public USkyraGameplayAbility
{
	GENERATED_BODY()

public:
	USkyraGameplayAbility_CharReset(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

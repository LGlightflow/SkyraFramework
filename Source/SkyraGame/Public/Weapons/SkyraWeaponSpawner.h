...
protected:
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadOnly, Category = "Skyra|WeaponPickup")
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "Skyra|WeaponPickup")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "Skyra|WeaponPickup")

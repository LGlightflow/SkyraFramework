...
#include "SkyraReplicationGraph.generated.h"

class AGameplayDebuggerCategoryReplicator;

DECLARE_LOG_CATEGORY_EXTERN(LogSkyraRepGraph, Display, All);

/** Skyra Replication Graph implementation. See additional notes in SkyraReplicationGraph.cpp! */
UCLASS(transient, config=Engine)
class USkyraReplicationGraph : public UReplicationGraph
{
	GENERATED_BODY()

public:
	USkyraReplicationGraph();
...
private:
	...
	/** Classes that had their replication settings explictly set by code in USkyraReplicationGraph::InitGlobalActorClassSettings */
	TArray<UClass*> ExplicitlySetClasses;
};

UCLASS()
class USkyraReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode_AlwaysRelevant_ForConnection
{
	GENERATED_BODY()
...
*/
UCLASS()
class USkyraReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()

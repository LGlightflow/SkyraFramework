...
#include "Abilities/SkyraGameplayAbility_CharReset.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraGameplayAbility_CharReset)

USkyraGameplayAbility_CharReset::USkyraGameplayAbility_CharReset(const FObjectInitializer& ObjectInitializer)
...
void USkyraGameplayAbility_CharReset::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	check(ActorInfo);
